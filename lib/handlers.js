...
handlers[WAMP.SUBSCRIBE] = function(session, args) {
    ...
    var eventCallback = function(subscriptionId, publicationId, args, kwargs) {
    ...
    var subscriptionId = session.subscribe(topicUri);
    this.substopic(topicUri, subscriptionId, eventCallback);
    msg = [
        WAMP.SUBSCRIBED,
        requestId,
        subscriptionId
